...
import com.tievoli.sbfuse.framework.exception.PermissionException;
...
public class ExceptionController extends AbstractErrorController {
    ...
    public ExceptionController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
        this(errorAttributes, new ArrayList<>(), errorProperties);
    }

    public ExceptionController(ErrorAttributes errorAttributes, List<ErrorViewResolver> errorViewResolvers, ErrorProperties errorProperties) {
